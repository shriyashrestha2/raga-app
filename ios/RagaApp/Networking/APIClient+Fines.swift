...
extension APIClient {
    ...
    @discardableResult
    func createFine(targetUserId: String, amountCents: Int, reason: String, status: FineStatus? = nil, issuedAt: Date? = nil, dueDate: Date? = nil, userId: String) async throws -> FineItem {
